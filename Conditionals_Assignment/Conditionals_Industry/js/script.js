...
(storeSales >= 30) ? console.log("Store sales are over the min of $30.") : storeSales = prompt ("Your store sales CANNOT be less than $30. Enter your week-to-date store sales, e.g. $20000:"); //If store sales are over 30miin, record in console. Otherwise, prompting the user again to enter in the stores total sales.;
if (storeSales === ""){ //Not allowing the user to leave the text field blank
    alert("You CANNOT leave the text field blank, enter in a number."); //Alerting the user that they can't leave the text field empty.
    console.log("Alert was sent because text field was left blank."); //Added to record the alert
    storeSales = prompt ("Enter your week-to-date store sales, e.g. $30000:"); //Prompting the user again to enter in the stores total sales.
...
(etSales >= 30) ? console.log("EasyTech sales are over the min of $30.") : etSales = prompt ("Your EasyTech sales CANNOT be less than $30. Enter your week-to-date EasyTech sales, e.g. $1200:"); ///If EasyTech sales are over 30miin, record in console. Otherwise, prompting the user again to enter in the stores total sales.;

var penRate =  (etSales / storeSales * 100);
console.log(penRate + "% Penetration rate.");
alert ("You have a current EasyTech penetration rate of " + penRate + "%.");
