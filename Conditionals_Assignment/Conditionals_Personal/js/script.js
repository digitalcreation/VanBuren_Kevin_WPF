...
if (caloriesSnack === ""){
    ...
    caloriesSnack = prompt("Enter in the total number of calories you had for any snacks throughout the day, e.g. 500.");//This will prompt the user to enter in the total number of calories eaten.
} //end of if
...
if(userWeight <= 150){
    alert("Your goal is " + lowerCalGoal + " calories." + " You have eaten " + totalCalories + " calories today.")
}else{
    alert("Your goal is " + HigherCalGoal + " calories." + " You have eaten " + totalCalories + " calories today.")
}