...
var monkeyGroom = prompt("How often do the monkey's groom each other a day?"); //Prompts the user to enter in a number amount.
console.log(monkeyGroom + " - How often monkey's groom each other, entered by user"); //Records the number entered in by the user.

var monkeyFling = prompt("How many times a day do the monkey's fling their feces?"); //Prompts the user to enter in a number amount.
...
var monkeyPlay = prompt("How many hours a day do the monkey's play games with each other?");
console.log(monkeyPlay + " - How many hours/day do the monkey's play games, entered by user");
