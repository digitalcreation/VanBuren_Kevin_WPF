...
var bagSize = prompt ("How many pounds are in your current dog food bag?"); //Will need to know how large the bag is to determine how long it will last.
...
var foodAnswer = "If your current bag of dog food is full it will be gone in "+ bagDayconvert + " days."; //Shows the user how many days before they will be out of the current bag of dog food.
