...
//This calculation will to calculate the total market basket $'s and penetration.
...
var pcSold = prompt("How many computers have you sold?"); //Prompts the user for how many computers have been sold, will be used for penetration.
...
console.log(ts2Sold + " - Number of 2 year Total Supports sold, entered by the user."); //Stores the number of 1 year total supports sold that the user entered.